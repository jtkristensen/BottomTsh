...
S132 sprintf "alive_%d", ir122
 chnset kr0, S132
ir135 FreePort 
 event_i "i", 19, 0.0, 0.25, ir135, ir1
 event_i "i", 22, 0.0, 0.25, 1.0, ir135
krl0 = 2.0
kr0 = krl0
S145 sprintf "alive_%d", ir135
 chnset kr0, S145
ir148 FreePort 
 event_i "i", 19, 1.25, 0.25, ir148, ir1
 event_i "i", 22, 1.25, 0.25, 1.0, ir148
krl0 = 2.0
kr0 = krl0
...
krl0 = 24.0
kr0 = krl0
S165 sprintf "alive_%d", ir1
 chnset kr0, S165
S168 sprintf "p1_%d", ir1
ar0 chnget S168
S171 sprintf "p2_%d", ir1
ar1 chnget S171
 chnclear S168
 chnclear S171
arl1 init 0.0
